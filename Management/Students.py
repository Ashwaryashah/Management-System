...
class Students:
    def __init__(self):
        ...
        m_title = Label(Manage_Frame, text="Manage Student", bg="grey", fg="black",
                        font=("times new roman", 30, "bold"))
        m_title.grid(row=0, columnspan=2, pady=10, sticky="w")

        lbl_roll = Label(Manage_Frame, text="Roll No:", bg="grey", fg="black", font=("times new roman", 30, "bold"))
        ...
        lbl_name = Label(Manage_Frame, text="Name:", bg="grey", fg="black", font=("times new roman", 30, "bold"))
        ...
        lbl_Email = Label(Manage_Frame, text="Email:", bg="grey", fg="black", font=("times new roman", 30, "bold"))
        ...
        lbl_Gender = Label(Manage_Frame, text="Gender:", bg="grey", fg="black", font=("times new roman", 30, "bold"))
        lbl_Gender.grid(row=4, column=0, pady=10, padx=20, sticky="w")

        lbl_Contact = Label(Manage_Frame, text="Contact:", bg="grey", fg="black",
                            font=("times new roman", 30, "bold"))
        ...
        lbl_dob = Label(Manage_Frame, text="D.O.B:", bg="grey", fg="black", font=("times new roman", 30, "bold"))
        ...
        lbl_Adress = Label(Manage_Frame, text="Address:", bg="grey", fg="black", font=("times new roman", 30, "bold"))
        ...
        lbl_search = Label(Detail_Frame, text="Search By:", bg="grey", fg="black", font=("times new roman", 20, "bold"))
    ...
    def add_students(self):
        try:
            if self.Roll_No_var.get() != '' and self.name_var.get() != '' and self.email_var.get() != '' and \
                    self.gender_var.get() != '' and self.contact_var.get() != '' and self.dob_var.get() != '' and self.address_var.get() != '':
    ...
    def update(self):
        ...
        if self.Roll_No_var.get() != '' and self.name_var.get() != '' and self.email_var.get() != ''\
                and self.gender_var.get() != '' and self.contact_var.get() != '' and self.dob_var.get() != '' and self.address_var.get() != '':
