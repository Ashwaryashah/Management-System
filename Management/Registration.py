...
class registration:
    def __init__(self):
        ...
        self.label_name = Label(self.frame_heading, bg='grey', text="Registration", font=('Arial', 20, 'bold'))
        self.label_name.pack()
        self.frame_login = Frame(self.window, bg='grey')
        self.frame_login.pack()
        self.label_un = Label(self.frame_login, font=('Calibri', 20, 'bold'), bg='grey', text="Username")
        ...
        self.label_pw = Label(self.frame_login, font=('Calibri', 20, 'bold'), bg='grey', text="Password")
        ...
        self.label_n = Label(self.frame_login, font=('Calibri', 20, 'bold'), bg='grey', text="Name")
        ...
        self.label_a = Label(self.frame_login, font=('Calibri', 20, 'bold'), bg='grey', text="Address")
        ...
        self.label_p = Label(self.frame_login, font=('Calibri', 20, 'bold'), bg='grey', text="Phone")
        ...
        self.label_e = Label(self.frame_login, font=('Calibri', 20, 'bold'), bg='grey', text="Email")
    ...
    def clear(self):
        ...
        self.entry_e.delete(0, END)
    def submit(self):
        if self.entry_un.get() == '' or self.entry_pw.get() == '' or self.entry_n.get() == '' or self.entry_a.get() == '' or self.entry_p.get() == '' or self.entry_e.get() == '':
