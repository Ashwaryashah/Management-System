...
class LoginView:
    def __init__(self):
        ...
        #========Button==========
        self.btn_login = Button(self.frame_login, bg='grey', text="Log In", font=('Calibri', 20, 'bold'),
                                command=self.on_login_click)
        self.btn_login.grid(row=2, column=0)
        self.btn_regis = Button(self.frame_login, bg='grey', text="Sign Up", font=('Calibri', 20, 'bold'),
                                command=self.signup)
